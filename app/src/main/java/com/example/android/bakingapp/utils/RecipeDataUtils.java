...
//this class extracts the data from the JSON file and populates the Objaect Recipe using NetworkUtils to call JSON feed
        ...
        try {
            ...
            for(int i = 0; i < recipesJSON.length(); i++) {
               ...
               // recipeObject.setIsFavorite(FavoritesUtils.isRecipeFavorite(context, recipeObject,
                ...
                RecipeFragment.mRecipesArray.add(recipeObject);
            }
